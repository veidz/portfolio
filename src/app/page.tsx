...
export default function Home() {
  return (
    <div className='min-h-screen bg-slate-950'>
      ...
      <About
        title='Sobre Mim'
        description='Desenvolvedor Full Stack com 5 anos de experiência em criar soluções web escaláveis e performáticas. Apaixonado por código limpo, arquitetura de software e novas tecnologias. Sempre em busca de desafios que me permitam evoluir e entregar valor real aos usuários.'
        yearsOfExperience={5}
        location='São Paulo, Brasil'
        highlights={[
          'Especialista em React, Next.js, TypeScript, Node.js e NestJS',
