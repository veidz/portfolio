...
export const About = ({
  ...
  return (
    <section
      id='about'
      className='min-h-screen flex items-center justify-center bg-secondary py-20'
    >
      <div className='container mx-auto px-4'>
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='bg-card rounded-lg p-8 md:p-12 shadow-xl'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <p className='text-sm text-muted'>Anos de</p>
